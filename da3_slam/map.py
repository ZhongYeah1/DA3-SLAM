...
from da3_slam.slam_utils import decompose_camera, cosine_similarity
        ...
        with open(file_name, "w") as f:
            ...
            for submap_index, submap in enumerate(self.ordered_submaps_by_key()):
                ...
                for frame_index, frame_id in enumerate(frame_ids):
                    ...
                    count += 1
                    # Dedup overlap frames (shared between adjacent submaps).
                    # count must increment regardless because all_poses indexes
                    # into the undeduplicated stack from get_all_cam_matricies.
